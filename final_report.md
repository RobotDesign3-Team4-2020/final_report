...
- [坂本](https://github.com/RobotDesign3-Team4-2020/crane_x7_/tree/T.sakamoto)
  ...
  - 情報収集
  - 会議の段取りや話の進行
  - cmakelistへの変更、c++のコンパイル、実行方法の確認[テストに用いたブランチ](https://github.com/RobotDesign3-Team4-2020/crane_x7_/tree/master/crane_x7_examples)
...
## まとめ
- 目標であったウンコの消毒とウンコの位置を認識させることができた
- 以前よりslackを活用し、毎週中間報告を設けることで各自の進捗を大まかに把握することができた
  - backlogやGithubをより活用すればさらに細かく進捗を把握できたと推測する
